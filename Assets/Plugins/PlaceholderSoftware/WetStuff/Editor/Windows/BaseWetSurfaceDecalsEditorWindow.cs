...
namespace PlaceholderSoftware.WetStuff.Windows
{
    internal abstract class BaseWetSurfaceDecalsEditorWindow
        : EditorWindow
    {
        private const float WindowBorder = 1f;
        private static readonly Color BackgroundColor = new Color32(64, 64, 64, 255);
        ...
        public void Awake()
        {
            _logo = Resources.Load<Texture2D>("WetSurfaceDecals_Large_Icon");
        }
