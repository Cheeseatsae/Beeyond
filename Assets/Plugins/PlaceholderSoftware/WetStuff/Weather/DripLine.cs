...
namespace PlaceholderSoftware.WetStuff.Weather
{
        ...
        : MonoBehaviour
    {
        ...
        private void UpdatePosition(bool force = false)
        {
            ...
            // Early exit if neither point has moved (using manhattan distance to keep is cheap to calculate)
            ...
            // Calculate the required transfor to connect the two points
            Vector3 p, r, s;
            CalculateLineTransform(a, b, out p, out r, out s);
