        ...
        : RcSharedState<WetDecalSystem.State>
    {
        ...
        internal class MaterialBatch : IDisposable
        {
            ...
            public MaterialBatch(Shader shader, MaterialPermutation permutation, MaterialProperties properties)
            {
                ...
                if (permutation.LayerMode == LayerMode.Single) material.EnableKeyword("LAYERS_SINGLE");
                if (permutation.LayerMode == LayerMode.Triplanar) material.EnableKeyword("LAYERS_TRIPLANAR");
                ...
                if (permutation.EnableJitter) material.EnableKeyword("JITTER_LAYERS");
